...
window.addEventListener("load", () => {
    ...
    let resEdu1 = document.getElementById('resEdu1');
    ...
    let reEdu2 = document.getElementById('reEdu2');
    ...
    let resobject = document.getElementById('resobject');
    resobject.textContent = object;
    let resSyear = document.getElementById('resSyear');
    resSyear.textContent = styear;
    let resEyear = document.getElementById('resEyear');
    ...
    let resSyear2 = document.getElementById('resSyear2');
    resSyear2.textContent = styear2;
    let resEyear2 = document.getElementById('resEyear2');
    resEyear2.textContent = endyear2;
    let resCom2 = document.getElementById('resCom2');
    resCom2.textContent = company2;
    let resLoc2 = document.getElementById('resLoc2');
    resLoc2.textContent = comlocation2;
    let resjob2 = document.getElementById('resjob2');
    resjob2.textContent = jobtitle2;
    let resAcha1 = document.getElementById('resAcha1');
    resAcha1.textContent = achievementsA1;
    let resAcha2 = document.getElementById('resAcha2');
    resAcha2.textContent = achievementsA2;
    let resAcha3 = document.getElementById('resAcha3');
